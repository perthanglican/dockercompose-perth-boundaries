...
class Bayswater(Parish):
    ...
    MORLEY_WALTER_RD = [83637447, 83637448, 83637449, 83637450, 83637451, 83637452, 83637453, 83637454, 83637455, 83637456, 83637457, 83637458, 83637459, 83637460, 83637461, 83637462, 83637462, 83637463, 83637464, 83637465, 83639344, 83639345]
    BEDFORD_BEAUFORT_ST = [83653651, 83637437, 83637438, 83637439, 83637431, 83637432, 83637433, 83637434, 83637435, 83637436, 83637543, 83637544, 83637545, 83637531]
    BAYSWATER_GREY_ST = [83638164, 83638163, 83638162, 83638161, 83638160, 83638159]

    def geom(self):
        def cut_morley():
            return self.cut_locality('MORLEY', 1, self.MORLEY_WALTER_RD)

        def cut_bedford():
            return self.cut_locality('BEDFORD', 2, self.BEDFORD_BEAUFORT_ST)

        def cut_bayswater():
            return self.cut_locality('BAYSWATER', 1, self.BAYSWATER_GREY_ST)
