...
class MountLawley(Parish):
    ...
    INGLEWOOD_JOHN_ST = Cut(
        'Inglewood - John St',
        RoadPath( 83654986, 83660734, 83660735, 83660736, 83660737, 83660738, 83660739, 83660740, 83654972, 83654979, 83654980, 83656578, 83653697, 83653698, 83653699, 83638245))
    INGLEWOOD_DUNDAS = Cut(
        'Inglewood - Dundas St',
        RoadPath(83653781, 83653780, 83653710, 83653709, 83653708, 83653707, 83653706, 83653705),
        RoadPath(83653717, 83653716, 83653715, 83653714, 83653712, 83653711, 83653672, 83653691))
    MTLAWLEY_LONGROYD_NORTH_WALCOTT = Cut(
        'Mt Lawley - Longroyd, ...',
        RoadPath(83653691, 83653690, 83653689, 83653688, 83653687, 83653686, 83653685, 83653684, 83653683, 83653682, 83653679, 83653678, 83653677),
        RoadPath(83667029, 83667030, 83667031, 83667032, 83667033, 83667034, 83667035, 83667036, 83667037, 83667038, 83667039, 83667040, 83667041, 83667042, 83667043, 83667044, 83667045, 83667046, 83667047, 83667048, 83667049, 83667050),
        RoadPath(83667206, 83667207, 83748909, 83748910),
        RoadPath(83639602, 83639601))
    MTLAWLEY_JOHN_THIRD = Cut(
        'Mt Lawley - John, Third St, ...',
        RoadPath(83660734, 83654986, 83654985, 83654984),
        RoadPath(83654842, 83654842, 83654844, 83654845, 83639421, 83639420))
